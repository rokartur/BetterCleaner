#!/usr/bin/env bash
#
# build_release.sh — Build, sign, notarize, and zip BetterCleaner for distribution.
#
# Usage:
...
#
# Output:
#   build/release/BetterCleaner-<version>-<build>.dmg
#   build/release/BetterCleaner-<version>-<build>.zip
#
# Requirements:
...
NOTARYTOOL_PROFILE="${NOTARYTOOL_PROFILE:-BetterCleanerNotary}"
SCHEME="BetterCleaner"
BUNDLE_ID="com.rokartur.BetterCleaner"
APP_NAME="BetterCleaner"
RELEASE_REPO="rokartur/BetterCleaner"
...
Options:
  ...
  --auto-release        After build+notarize, auto-create GitHub release on
                        rokartur/BetterCleaner with DMG+ZIP attached.
